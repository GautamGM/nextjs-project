      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-playfair font-bold text-gold-500">Luxuria</h3>
            <p className="text-gray-400">
              Crafting extraordinary experiences for the discerning few since 1999
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              {['Collections', 'About Us', 'Gallery', 'Blog'].map((link) => (
                <li key={link}>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-400">contact@luxuria.com</li>
              <li className="text-gray-400">
                101 Park Avenue, Suite 1600<br/>
                New York, NY 10178
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <form className="flex flex-col space-y-3">
              <input 
                ...
                className="bg-slate-800 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gold-500"
              />
              <button
                type="submit"
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 text-center">
          <p className="text-gray-500">
            © {new Date().getFullYear()} Luxuria. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
